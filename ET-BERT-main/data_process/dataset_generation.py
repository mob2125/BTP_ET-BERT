...
word_dir = "C:\\Users\\vamsi\\Downloads\\ET-BERT-main\\ET-BERT-main\\corpora\\"
...
def split_cap(pcap_path, pcap_file, pcap_name, pcap_label='', dataset_level = 'flow'):
    ...
    if dataset_level == 'flow':
        cmd = "C:/Users/vamsi/Downloads/ET-BERT-main/ET-BERT-main/SplitCap.exe -r %s -s session -o " + output_path
    elif dataset_level == 'packet':
        cmd = "C:/Users/vamsi/Downloads/ET-BERT-main/ET-BERT-main/SplitCap.exe -r %s -s packets 1 -o " + output_path
    print(pcap_file)
...
def pretrain_dataset_generation(pcap_path):
    output_split_path = "C:\\Users\\vamsi\\Downloads\\ET-BERT-main\\ET-BERT-main\\dataset"
    pcap_output_path = "C:\\Users\\vamsi\\Downloads\\ET-BERT-main\\ET-BERT-main\\dataset2\\"
...
if __name__ == '__main__':
    # pretrain
    pcap_path = "C:\\Users\\vamsi\\Downloads\\ET-BERT-main\\ET-BERT-main\\newdata\\"
    # tls 13 downstream
